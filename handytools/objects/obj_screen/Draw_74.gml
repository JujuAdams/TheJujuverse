...
if ( SCREEN_3D ) {
    ...
    if ( DEVELOPMENT && global.screen_show_click && ( !SCREEN_ALLOW_DEFERRED || !global.screen_do_deferred ) ) {
...
if ( global.game_room != 0 ) && ( global.game_room != 10 ) {
    ...
    var _scale = 10;
    draw_sprite_ext( spr_white_pixel, 0, _x-_scale div 2, _y-_scale div 2, _scale, _scale, 0, c_white, 0.3 );
}