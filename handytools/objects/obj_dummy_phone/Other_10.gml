...
vertex_submit( dotobj_model( "phonebase" ), pr_trianglelist, sprite_get_texture( spr_tex_phone_base, 0 ) );
vertex_submit( dotobj_model( "phonerotary" ), pr_trianglelist, sprite_get_texture( spr_tex_phone_rotary, 0 ) );
...
if ( global.game_room == 6 ) matrix_chain_translate( 0, 0, -global.game_swell );
matrix_chain_end( matrix_world );
vertex_submit( dotobj_model( "phoneheadset" ), pr_trianglelist, sprite_get_texture( spr_tex_phone_headset, 0 ) );
matrix_reset_world();