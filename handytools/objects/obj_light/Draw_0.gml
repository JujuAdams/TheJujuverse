...
shader_set_uniform_f( shader_get_uniform( shd_per_texel_lighting, "u_vForceColour" ), colour_get_red( colour )/255,
...
shader_set_uniform_f( shader_get_uniform( shd_per_texel_lighting, "u_vForceColour" ), 1.0, 1.0, 1.0, 0.0 );