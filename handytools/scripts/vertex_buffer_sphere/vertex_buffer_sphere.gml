...
/*
	...
	var _this_b = [ _mx+_rx*_rd1*_cc[_i],  _my+_ry*_rd1*_ss[_i], _mz+_rz*_rh1,
	                  _hrepeat*_i/_steps,     _j*_vrepeat/_rows,
						         c_white,                     1,
						    _rd1*_cc[_i],          _rd1*_ss[_i],         _rh1 ];
	...
	for( _i = 0; _i <= _steps; _i++ ) {
		...
		_this_a = [ _mx+_rx*_rd1*_cc[_i],  _my+_ry*_rd1*_ss[_i], _mz+_rz*_rh1,
		              _hrepeat*_i/_steps,     _j*_vrepeat/_rows,
						         c_white,                     1,
						    _rd1*_cc[_i],          _rd1*_ss[_i],         _rh1 ];
		
		_this_b = [ _mx+_rx*_rd1*_cc[_i],  _my+_ry*_rd1*_ss[_i], _mz+_rz*_rh1,
		              _hrepeat*_i/_steps,     _j*_vrepeat/_rows,
				                 c_white,                     1,
					        _rd1*_cc[_i],          _rd1*_ss[_i],         _rh1 ];
