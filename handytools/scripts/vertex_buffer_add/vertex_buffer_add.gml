...
var _dest_count   = (_dest_vbuff==undefined)? 0 : vertex_get_number( _dest_vbuff );
...
if ( _dest_count > 0 ) buffer_copy_from_vertex_buffer( _dest_vbuff, 0, _dest_count, _dest, 0 );
