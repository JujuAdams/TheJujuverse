/// @description TRACKER map nesting inside list
/// @param id
/// @param value
...
if ( TRACKER_ON ) {
    ...
    var _root_list = global.tracker_list_nested_maps[? _id ];
    if ( _root_list == undefined ) {
        ...
        _root_list = global.tracker_list_nested_maps[? _id ];
    }
