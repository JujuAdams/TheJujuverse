/// @description Returns the HMAC-SHA512 hash of a string
/// @param key
/// @param string
...
var sha = sha512_buffer( buf_innerPad, 0, buffer_tell( buf_innerPad ) );
...
var result = sha512_buffer( buf_outerPad, 0, buffer_tell( buf_outerPad ) );
