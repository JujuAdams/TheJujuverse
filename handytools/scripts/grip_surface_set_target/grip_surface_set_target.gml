...
var _primary_is_depth = grip_get_primary_is_depth( _grip );
if ( !ALLOW_MRT ) ||
( ( ( _depth_surface == undefined ) || _primary_is_depth ) && ( _normal_surface == undefined ) ) {
    
    if ( !_skip_primary ) {
        surface_set_target( _primary_is_depth? _depth_surface : _surface );
    }
