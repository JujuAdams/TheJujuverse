...
object_default_properties( "<null>", _list );

//Define debug primitives
object_declare_default( [ obj_sphere, obj_cone, obj_tri_a, obj_tri_b, obj_tri_c, obj_tri_sphere, obj_line_a, obj_line_b ] );

//Define a typical basic object
object_add_property( obj_player_spawn, "rotation", E_EDITOR_PROPERTY.FLOAT, 0, "image_angle" );

//Basically all objects in the game inherit from the player spawner
object_copy_property( obj_player_spawn, [ obj_door_spawn, obj_phone, obj_dummy_phone, obj_cube,
...
object_add_property( obj_light, "colour", E_EDITOR_PROPERTY.COLOUR, c_white, UD );
object_add_property( obj_light, "range" , E_EDITOR_PROPERTY.FLOAT ,     200, UD );
