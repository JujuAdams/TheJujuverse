...
for( var _i = 0; _i < _size; _i++ ) {
	...
	_str += string_space_padded( _i, TRACKER_ID_SPACE_PADDING ) + ":id=" + string_space_padded( _id, TRACKER_ID_SPACE_PADDING ) + ": " + tr_vertex_details( _id, TRACE_DEFAULT_DIVIDER ) + NL;
}
